...
<html>
	...
	<body>
<!-- 	<form action="reservacion.php" method="post" name="vuelos_busqueda" id="vuelos_busqueda"> -->
		<form action="formulario_pasajero.html" method="post" name="vuelos_busqueda" id="vuelos_busqueda">
			<?php
			    //echo $_POST;
				//echo $_GET;
			    ...
			    //$origen=$_GET['id_origen']; //para ver los parametros desde la url :)
			      ...
			      */ 
			      ...
			      $consulta  = "select * from cronograma where c_origen = \"$origen\" and c_destino = \"$destino\" ";
		...
		// 	      		}
						...
						echo "</br>";
						echo "No hay vuelos dispobibles...";	      		
			      	}
