...
-- DDL
create table ciudad (c_cod  				integer primary key,
                     c_desc                 varchar(100)
                    ); 
...
create table vuelo (v_cod	  				integer primary key, 
...
create table reserva (r_cod	  				integer primary key, 
...
create table pasaje  (pasaje_cod			integer primary key, 
